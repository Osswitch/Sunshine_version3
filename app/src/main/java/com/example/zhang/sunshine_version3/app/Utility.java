...
public class Utility {
    ...
    public static String getPreferredLocation(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_location_key),
                context.getString(R.string.pref_location_defValue));
    }

    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_unit_key),
                context.getString(R.string.pref_unit_defValue))
                .equals(context.getString(R.string.unit_entryValue_metric));
    }
    ...
    public static String getArtUrlResourceForWeatherCondition(Context context, int weatherId) {

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        String formatArtUrl = preferences.getString(context.getString(R.string.pref_icon_key),
                context.getString(R.string.pref_icon_defValue));
        String a = String.format(Locale.US, formatArtUrl, "storm");
