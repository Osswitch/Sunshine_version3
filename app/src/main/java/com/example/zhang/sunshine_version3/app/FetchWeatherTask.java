...
import com.example.zhang.sunshine_version3.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low, String unit){
        if(unit.equals(mContext.getString(R.string.unit_entryValue_imperial))){
            high = (high * 1.8) + 32;
            low = (low * 1.8) +32;
        }else if (!unit.equals(mContext.getString(R.string.unit_entryVaule_metric))){
    ...
    String[] convertContentValuesToUXFormat(Vector<ContentValues> cvv) {
        ...
        for ( int i = 0; i < cvv.size(); i++ ) {
            ...
            String unit = PreferenceManager.getDefaultSharedPreferences(mContext)
                    .getString(mContext.getString(R.string.pref_unit_key),
                            mContext.getString(R.string.pref_unit_defValue));
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContext.getContentResolver().
                        bulkInsert(WeatherContract.LocationEntry.CONTENT_URI, cvArray);
            }
